    ...
    <div class="table-header">
      ...
      <div v-if="toolButton" class="header-button-ri">
        <slot name="toolButton">
          <el-space>
            <el-tooltip v-if="showToolButton('refresh')" :content="$t('components.ProTable.refresh')" placement="top">
            ...
            <el-tooltip
              ...
              :content="$t('components.ProTable.search')"
              placement="top"
            >
              <el-button :icon="Search" circle @click="isShowSearch = !isShowSearch" />
            </el-tooltip>
            <el-tooltip v-if="isTreeData" :content="$t('components.ProTable.switchGraph')" placement="top">
