      ...
      <div class="station-status">
        ...
        <div class="status-list">
          <div class="status-header">
            ...
            <div>{{ t("home.stationStatus.percentage") }}</div>
          </div>
          <div class="status-item">
            ...
            <div class="status-percent">{{ props.stationInfo.onlineRate }}</div>
          </div>
          <div class="status-item">
            <div class="status-info">
            ...
            <div class="status-percent">{{ props.stationInfo.offlineRate }}</div>
          </div>
          <div class="status-item">
            <div class="status-info">
            ...
            <div class="status-percent">{{ props.stationInfo.faultRate }}</div>
          </div>
          <div class="status-item">
            <div class="status-info">
            ...
            <div class="status-percent">{{ props.stationInfo.alarmRate }}</div>
          </div>
        </div>
      </div>
    </div>
