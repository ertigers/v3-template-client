<template>
  <el-drawer v-model="drawerVisible" :title="$t('layouts.themeDrawer.title')" size="290px">
    ...
    <el-divider class="divider" content-position="center">
      ...
      {{ $t("layouts.themeDrawer.layoutStyle") }}
    </el-divider>
    <div class="layout-box">
      <el-tooltip effect="dark" :content="$t('layouts.themeDrawer.layoutVertical')" placement="top" :show-after="200">
      ...
      <el-tooltip effect="dark" :content="$t('layouts.themeDrawer.layoutClassic')" placement="top" :show-after="200">
      ...
      <el-tooltip effect="dark" :content="$t('layouts.themeDrawer.layoutTransverse')" placement="top" :show-after="200">
        <div
      ...
      <el-tooltip effect="dark" :content="$t('layouts.themeDrawer.layoutColumns')" placement="top" :show-after="200">
    ...
    <div class="theme-item">
      <span>
        {{ $t("layouts.themeDrawer.sidebarInverted") }}
        <el-tooltip effect="dark" :content="$t('layouts.themeDrawer.sidebarInvertedTooltip')" placement="top">
    ...
    <div class="theme-item mb50">
      <span>
        {{ $t("layouts.themeDrawer.headerInverted") }}
        <el-tooltip effect="dark" :content="$t('layouts.themeDrawer.headerInvertedTooltip')" placement="top">
          <el-icon><QuestionFilled /></el-icon>
        </el-tooltip>
      </span>
    ...
    <el-divider class="divider" content-position="center">
      ...
      {{ $t("layouts.themeDrawer.globalTheme") }}
    </el-divider>
    <div class="theme-item">
    ...
    <div class="theme-item">
      <span>{{ $t("layouts.themeDrawer.darkMode") }}</span>
      <SwitchDark />
    </div>
    <div class="theme-item">
      <span>{{ $t("layouts.themeDrawer.greyMode") }}</span>
      <el-switch v-model="isGrey" @change="changeGreyOrWeak('grey', !!$event)" />
    </div>
    <div class="theme-item mb40">
      <span>{{ $t("layouts.themeDrawer.weakMode") }}</span>
    ...
    <el-divider class="divider" content-position="center">
      ...
      {{ $t("layouts.themeDrawer.interfaceSettings") }}
    </el-divider>
    <div class="theme-item">
      <span>{{ $t("layouts.themeDrawer.menuCollapse") }}</span>
      <el-switch v-model="isCollapse" />
    </div>
    <div class="theme-item">
      <span>{{ $t("layouts.themeDrawer.menuAccordion") }}</span>
      <el-switch v-model="accordion" />
    </div>
    <div class="theme-item">
      <span>{{ $t("layouts.themeDrawer.watermark") }}</span>
      <el-switch v-model="watermark" />
    </div>
    <div class="theme-item">
      <span>{{ $t("layouts.themeDrawer.breadcrumb") }}</span>
      <el-switch v-model="breadcrumb" />
    </div>
    <div class="theme-item">
      <span>{{ $t("layouts.themeDrawer.breadcrumbIcon") }}</span>
      <el-switch v-model="breadcrumbIcon" />
    </div>
    <div class="theme-item">
      <span>{{ $t("layouts.themeDrawer.tabs") }}</span>
      <el-switch v-model="tabs" />
    </div>
    <div class="theme-item">
      <span>{{ $t("layouts.themeDrawer.tabsIcon") }}</span>
      <el-switch v-model="tabsIcon" />
    </div>
    <div class="theme-item">
      <span>{{ $t("layouts.themeDrawer.footer") }}</span>
